...
public class IgniteCacheEndpointConfigurer extends PropertyConfigurerSupport implements GeneratedPropertyConfigurer, PropertyConfigurerGetter {
    ...
    public Map<String, Object> getAllOptions(Object target) {
        ...
        answer.put("autoUnsubscribe", boolean.class);
        answer.put("basicPropertyBinding", boolean.class);
        answer.put("bridgeErrorHandler", boolean.class);
        answer.put("cachePeekMode", org.apache.ignite.cache.CachePeekMode.class);
        answer.put("exceptionHandler", org.apache.camel.spi.ExceptionHandler.class);
        answer.put("exchangePattern", org.apache.camel.ExchangePattern.class);
        answer.put("failIfInexistentCache", boolean.class);
        answer.put("fireExistingQueryResults", boolean.class);
        answer.put("lazyStartProducer", boolean.class);
        answer.put("oneExchangePerUpdate", boolean.class);
        answer.put("operation", org.apache.camel.component.ignite.cache.IgniteCacheOperation.class);
        answer.put("pageSize", int.class);
        answer.put("propagateIncomingBodyIfNoReturnValue", boolean.class);
        answer.put("query", org.apache.ignite.cache.query.Query.class);
        answer.put("remoteFilter", org.apache.ignite.cache.CacheEntryEventSerializableFilter.class);
        answer.put("synchronous", boolean.class);
        answer.put("timeInterval", long.class);
